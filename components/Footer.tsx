...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black mt-5 border-t border-gray-100">
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-0 justify-center md:justify-between items-center flex-wrap mt-10 border-t border-gray-100 sm:px-16 px-6 py-10">
